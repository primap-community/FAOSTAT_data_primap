...
1. Bump the version: manually trigger the "bump" workflow from the main branch
   (see here: [bump workflow](https://github.com/primap-community/FAOSTAT_data_primap/actions/workflows/bump.yaml)).
...
1. Edit the draft release which has been created
   (see here:
   [project releases](https://github.com/primap-community/FAOSTAT_data_primap/releases)).
